+++
title = "ETL"
summary = "ETL for ticket sales analysis"
...
{% figure(url="./computer-tool.svg", alt="Computer with wrench in front of it (decorative)", width="20em") %}
...
{{ figure(url="./veritix_logo.png", alt="Veritix Logo", width="40em") }}
